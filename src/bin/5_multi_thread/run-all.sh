...
# echo \n\n
# echo "PGO"
# command time -h ./target/aarch64-apple-darwin/release/5_multi_thread ./data/1m.txt 1>/dev/null
# command time -h ./target/aarch64-apple-darwin/release/5_multi_thread ./data/10m.txt 1>/dev/null
# command time -h ./target/aarch64-apple-darwin/release/5_multi_thread ./data/100m.txt 1>/dev/null
# command time -h ./target/aarch64-apple-darwin/release/5_multi_thread ./data/1b.txt 1>/dev/null